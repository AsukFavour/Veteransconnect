  ...
  return (
    <div className="about-us">
      ...
      <p className="about-us__text">
        ...
        needs. From health awareness and education to education and training,
        entrepreneurship courses, employment, support services and much more.
      </p>
      <p className="about-us__text">
        Join us as we provide comprehensive support to retired military
        veterans. Together, we can make a difference in the lives of veterans in
        Africa.
      </p>
    </div>
  );
